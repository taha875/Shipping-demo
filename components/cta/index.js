...
const index = () => {
  return (
    ...
    //         <h1 className="mt-2 lg:mt-0 text-color-purple">Shipping</h1>
    //         <h1 className="mt-2 lg:mt-0">Partner</h1>
    //       </div>
    //       <h2 className="text-lg lg:text-2xl tracking-wide leading-9 lg:w-10/12 mt-2 lg:mt-6 text-color-gray-light">
    //         Providing best insurance rates to families and individuals all
    //         around the globe
    //       </h2>
    //       <button className="flex items-center relative focus:outline-none justify-center mt-5 lg:mt-10 text-lg lg:text-2xl font-medium text-white py-4 px-8 bg-color-purple rounded-3xl">
    //         Get a quote
    //         <svg
    //           className="ml-8"
    ...
    //         <img
    //           loading="lazy"
    //           className="absolute inset-0 m-auto w-2/3 md:-mb-20 xl:-mb-40"
    ...
    //         <img
    //           loading="lazy"
    //           className="absolute xl:-mt-10 w-1/4 right-0"
    ...
    //         </svg>
    //         <div className="text-color-gray w-1/2 pl-12">
    //           <h1 className="font-bold text-2xl lg:text-5xl tracking-1px">5</h1>
    //           <h2 className="text-base lg:text-lg mt-4 leading-8 tracking-wide">
    //             Years of Experience
    //           </h2>
    //         </div>
    ...
    //   </div>
    // </div>
    <div className="carousel-height relative overflow-hidden">
      <div className="absolute bg-yellow-500 flex flex-col items-center justify-center bg-opacity-70 h-full w-full z-20">
        <h1 className="text-[70px] font-black text-center text-gray-800 leading-[80px]">
          RIGHT SHIPPING <br /> DECISIONS
        </h1>
        <h2 className="text-lg lg:text-2xl tracking-wide   mt-2 lg:mt-6 text-gray-700 text-center font-semibold">
          Providing best insurance rates to families and individuals <br /> all
          around the globe
        </h2>
        <button className="bg-gray-800 text-gray-100 py-4 px-6 text-lg rounded-md mt-6 hover:bg-gray-700">
          Read More
        </button>
      </div>
      <CarouselProvider
