const footer = () => {
  return (
    <>
      <div className="bg-yellow-500 px-4 lg:px-0 py-10 lg:py-32 ">
        <div className="w-full lg:flex justify-between mx-auto container">
            ...
            <div className="flex flex-col mt-4 lg:mt-0">
              <ul>
                <li>
                  <p
                    href
                    className="text-lg text-gray-700 tracking-wide font-semibold"
                  >
                    Shipping
                  </p>
                </li>
                <li className="mt-6">
                  <a href className="text-base text-gray-700 tracking-wide">
                    How it works
                  </a>
                </li>
          ...
          <div className="w-full lg:w-1/2 mt-10 lg:mt-0 flex justify-center lg:justify-end">
            <div className="w-10/12 lg:w-1/2">
              <h1 className="text-lg text-gray-700 font-semibold tracking-wide mb-6 text-center lg:text-left">
                Subscribe to our Newsletter
              </h1>
              <div className="flex justify-center">
                <div className="w-full bg-white rounded-2xl flex justify-center items-center relative">
                  <input
                    type="email"
                    required
                  ...
                  <button
                    type="submit"
                    className="absolute right-0 inset-y-0 h-full focus:outline-none transition duration-150 border-l border-gray-300 text-xs lg:text-base font-medium bg-gray-900 ease-in-out rounded text-gray-100 px-2 sm:px-6 py-2 lg:py-4"
                  >
                    Subscribe
                  </button>
                </div>
