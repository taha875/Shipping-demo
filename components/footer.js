const footer = () => {
  return (
    <>
      <div className="bg-color-purple px-4 lg:px-0 py-10 lg:py-32 ">
            ...
            <div className="flex flex-col mt-4 lg:mt-0">
              <ul>
                <li>
                  <p
                    href
                    className="text-lg text-white tracking-wide font-semibold"
                  >
                    Shipping
                  </p>
                </li>
            ...
            <div className="w-10/12 lg:w-1/2">
              ...
              <div className="flex justify-center">
                <div className="w-full bg-white rounded-2xl flex justify-center items-center relative">
                  ...
                  <button
                    type="submit"
                    className="absolute right-0 inset-y-0 h-full focus:outline-none transition duration-150 border-l border-gray-300 text-xs lg:text-base font-medium text-color-purple ease-in-out rounded text-white px-2 sm:px-6 py-2 lg:py-4"
                  >
                    Subscribe
                  </button>
                </div>
